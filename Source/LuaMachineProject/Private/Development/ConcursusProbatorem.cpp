...
void AConcursusProbatorem::TestCollide2() {
	...
	turret1 = GetWorld()->SpawnActor<ATurret>(FVector::ZeroVector, FRotator::ZeroRotator, Params);
	...
	enemy2 = GetWorld()->SpawnActor<AEnemy>(WraithClass, FVector(20, 20, 0), FRotator::ZeroRotator, Params);

	enemy2->SetActorLocation(enemy1->GetActorLocation() + FVector(0.1f, 0.1f, 0));
